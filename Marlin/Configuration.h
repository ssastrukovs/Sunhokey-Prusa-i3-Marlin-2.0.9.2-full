...
#define STRING_CONFIG_H_AUTHOR "Andrzej Pomirski" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  17.2,  17.2 }
    #define DEFAULT_Ki_LIST {   1.26,   1.26 }
    #define DEFAULT_Kd_LIST {58.85, 58.85 }
  #else
    #define DEFAULT_Kp 17.2
    #define DEFAULT_Ki 1.26
    #define DEFAULT_Kd 58.85
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 76.82
  #define DEFAULT_bedKi 5.01
  #define DEFAULT_bedKd 294.21
...
#define CLASSIC_JERK
  ...
  //#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 20, 4, 0.6, 10 } // ...or, set your own edit limits
  #endif
#endif
